...
class Runner(object):
    ...
    def add_model(self, model, score_func):
        ...
        if model_name.lower() == 'disenkge_ddi_distmult':
            model = DisenKGE_DDI_DistMult(self.edge_index, self.edge_type, params=self.p)

        elif model_name.lower() == 'disenkge_ddi_interacte':
            model = DisenKGE_DDI_InteractE(self.edge_index, self.edge_type, params=self.p)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-model', dest='model', default='disenkge_ddi', help='Model Name')
    ...
    # parser.add_argument('-init_gamma', type=float, default=1.0, help='Margin')
